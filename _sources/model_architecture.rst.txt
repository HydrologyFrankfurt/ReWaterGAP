Model Architecture
==================
WaterGap is structured using the model view controller (MVC) software architectural pattern [1]_. This pattern is chosen since it improves the software's organization via separating the software components into three parts namely: 
