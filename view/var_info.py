...
modelvars = {
    ...
    "lai":   {"long": "Leaf area index", "unit": "mm/day"},
    ...
    "groundwater_recharge": {"long": "Groundwater recharge", "unit": "mm/day"},
    ...
    "groundwater_storage": {"long": "Groundwater storagee", "unit": "km3"},
    "locallake_storage": {"long": "Locallake storage", "unit": "km3"},
    "localwetland_storage": {"long": "Localwetland storage", "unit": "km3"},
    "globallake_storage": {"long": "Globallake storage", "unit": "km3"},
    "globalwetland_storage": {"long": "Globalwetland storage", "unit": "km3"},
    "river_storage": {"long": "River storage",  "unit": "km3"}
}