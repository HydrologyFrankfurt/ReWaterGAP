        ...
        for key, value in obj.items():
            if isinstance(value, dict):
                ...
                if "save_and_read_states_dir" in key or "start" in key or 'end' in key\
                    ...
                    or "path_to_stations_file" in key or "path_to_observed_discharge" in key or 'calib_forcing' in key or key in (
                        'res_operation_algorithm', 'reservoir_forcing',
                        'reservoir_routing_data_path'):
