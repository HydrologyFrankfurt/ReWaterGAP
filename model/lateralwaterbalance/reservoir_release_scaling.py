...
def scaling_res_reslease(storage, stor_capacity,
   ...
   # See Hosseini-Moghari et al. (2025) for more detailes https://doi.org/10.5194/hess-29-4073-202
    ...
    if counter_for_mean_30days <= 29: # 30 days 0-29
        
        res_inflow_past_30days [counter_for_mean_30days] = inflow_to_swb
    ...
    return release, counter_for_mean_30days
