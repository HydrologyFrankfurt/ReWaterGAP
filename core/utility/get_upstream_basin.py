    ...
    def __init__(self, run_upstream_basin,  arc_id,  stations, lat_lon_arcid, inflow_cell):
        ...
        if run_upstream_basin:
            ...
            for lat, lon in zip(latitudes, longitudes):
                ...
                selected_row =  \
                    lat_lon_arcid[(lat_lon_arcid['Lon'] == lon) &
                                  (lat_lon_arcid['Lat'] == lat)]['ArcID']
            ...
            all_upstream = SelectUpstreamBasin.\
                get_all_upstream_cells_arcid(selected_arcids, inflow_cell, upstream_cells)
