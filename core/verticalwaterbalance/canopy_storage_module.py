...
def daily_canopy_storage(canopy_storage,
                         daily_leaf_area_index,
                         potential_evap,
                         precipitation,
                         land_area_frac):
    """
    Calulate daily canopy storage.

    Parameters
    ----------
    canopy_storage : array
        Daily canopy stroage,  Units: mm
    ...
    # =================================================================
    # max_storage_coefficient =  maximum storage coefficient (mm)
    # see Eq. 4 in Müller Schmied et al 2021. for maximum storage equation
    max_canopy_storage = pm.max_storage_coefficient * daily_leaf_area_index
    ...
    # actual variable 'canopy_evap' after comparison with the canopy storage
    # canopy_evap_cal is calulated using Eq.6 in Müller Schmied et al 2021.
    canopy_evap_cal = potential_evap * canopy_storage_fraction**(2 / 3)
