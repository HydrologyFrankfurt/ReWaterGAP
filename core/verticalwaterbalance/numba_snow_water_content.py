...
# =============================================================================
# This module calulates snow water water balances, including snow water storage
...
# parallel (see run_parallel_snow function line 283).
# =============================================================================
...
def numba_snow(snow_water_storage, snow_water_storage_subgrid, temperature,
               precipitation, throughfall, pet_to_soil,
               land_storage_change_sum, degreeday, land_area_frac, elevation):
    """
    Compute snow water storage and related fluxes.
    ...
    # Defining constants
    # =====================================================================
    adiabatic_lapse_rate = (0.6/100)  # K/m or °C/m
    ...
    # Selecting all 100 subgrids for elevation_subgrid(dimension = 100x360x720)
...
def run_snow_parallel(snow_water_storage_chunk,
                      snow_water_storage_subgrid_chunk, temperature_chunk,
                      precipitation_chunk, throughfall_chunk,
                      pet_to_soil_chunk, land_storage_change_sum_chunk,
                      degreeday_chunk, land_area_frac_chunk, elevation_chunk):
    """
    Compute snow storage in parallel.
    ...
    """
    # creatting empty arrays to store output values from numba_snow function.
