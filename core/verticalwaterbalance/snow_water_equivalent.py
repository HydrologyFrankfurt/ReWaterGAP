...
# =============================================================================
# This module calls the numba optimised snow water storage function from the
# numba_snow_water_content module to compute snow water balnce including,
# snow water storage and related fluxes for all grid cells.
...
import numpy as np
from core.verticalwaterbalance import numba_snow_water_content as nb_sw
...
class Snow():
    ...
    def cal_snow(self, land_area_frac, temperature, throughfall,
        ...
        # =====================================================================
        snow_output = \
            nb_sw.run_snow_parallel(snow_water_storage_chunk,
                                    snow_water_storage_subgrid_chunk,
