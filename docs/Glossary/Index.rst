...
.. csv-table:: Consumptive Use
   ...
   ":math:`{CU_tot,irr}`", "Consumptive water use in the irrigation sector"
   ":math:`{CU_tot,dom}`", "Consumptive water use in the domestic sector"
   ":math:`{CU_tot,man}`", "Consumptive water use in the manufacturing sector"
   ":math:`{CU_tot,tp}`", "Consumptive water use in the thermal power sector"
   ":math:`{CU_tot,liv}`", "Consumptive water use in the livestock sector"
   ":math:`{CU_tot}`", "Total consumptive use"
