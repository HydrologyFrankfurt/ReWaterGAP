...
.. math::
   {NA}_{pot,s} = WApot,s,irri- (1-frgi)(WApot,s,irri-CUpot,s,irri) \\ {eff}= CUpot,s,irri/WApot,s,irri \\ NApot,s = WApot,s,irri- (1-frgi)(WApot,s,irri-eff WApot,s,irri) \\ NApot,s = WApot,s,irri- (1-frgi)(1-eff) WApot,s,irri \\ NApot,s = WApot,s,irri [1-(1-frgi)(1-eff)] \\ factor = [1-(1-frgi)(1-eff)] \\ NApot,s = factor WApot,s,irri \\ NAs = NApot,s - UnNApot,s \\ factor WAs,irri = factor WApot,s,irri - UnNApot,s \\ WAs,irri = (1/factor) (factor WApot,s,irri - UnNApot,s)
