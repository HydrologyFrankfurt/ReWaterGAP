...
.. autofunction:: lakes_wetlands.lake_wetland_water_balance
...
In arid and semiarid grid cells, lakes and wetlands are assumed to recharge the groundwater through focused groundwater recharge (:math:`{R}_{{g}_{l,w}}`). In humid areas, groundwater mostly recharges surface water bodies [2]_, as explained in Section 4.6.2 [1]_. The focussed groundwater recharge :math:`{R}_{{g}_{l,w}}` is calculated as:
