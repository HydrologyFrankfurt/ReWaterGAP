...
.. autofunction:: groundwater.groundwater_balance
...
Details on the computation of the actual net abstaction groundwater can be found in the :ref:`water abstractions <net_abstractions>` section. net_abstractions:
